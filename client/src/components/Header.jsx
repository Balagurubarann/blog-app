  ...
  return (
    <Navbar className="border-b py-6">
      ...
      <div className="flex gap-4 md:order-2">
        <Button className="w-12 h-10 hidden sm:inline border dark:text-white" color="grey" pill onClick={() => dispatch(toggleTheme())}>
          {
        ...
        {currentUser ? (
          <Dropdown
            arrowIcon={false}
            inline
            label={<Avatar alt="user" img={currentUser.profilePicture} rounded className="w-12 h-6" />}
          >
            <Dropdown.Header>
